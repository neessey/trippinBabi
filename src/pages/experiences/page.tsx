  ...
  const activities: ActivityCard[] = [
    {
      ...
      description: "Partez à la découverte de Grand-Bassam, Abidjan ou Assinie à travers des scénarios immersifs mênant énigmes, patrimoine et défis collaboratifs.",
...
},
{
...
}, 
 {
  ...
  {
    act.category === "experiences"
      ? "EXPÉRIENCE"
      : act.category === "jeux-culturels"
      ? "JEU CULTUREL"
      : act.category === "ateliers"
      ? "ATELIER"
      : act.category === "team-building"
      ? "TEAM BUILDING"
      : act.category.toUpperCase()
            ...
            <div className="p-6 flex flex-col flex-1">
              ...
              <div className="border-t border-[#E8E0D5]/50 pt-4 flex items-center justify-between">
                ...
                <button
  onClick={() => {
    if (act.category === "team-building") {
      onNavigate("corporate");

      setTimeout(() => {
        document
          .getElementById("quote-block")
